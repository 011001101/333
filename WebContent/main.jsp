...
<body>
	...
	<div class="map">
		...
		<div class="LAND">
			<div class="Garden" name="Garden" data-description="화원으로"
				type="button" onclick="gamego()">
				<div class="MAP-inner">
					<div class="title">화원</div>
					<div class="description">화원으로 이동</div>
				</div>
			</div>
			<div class="Library" name="Library" data-description="도서관으로"
				type="button" onclick="encygo()">
				<div class="MAP-inner">
					<div class="title">도서관으로</div>
					<div class="description">도서관으로 이동</div>
				</div>
			</div>
			<div class="Shop" name="Shop" data-description="상점으로" type="button"
				onclick="shopgo()">
				<div class="MAP-inner">
