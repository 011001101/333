...
<div class="Lightpot" name="pot">
    <div class="plantpot" name="plant1"  type="button" onclick="alert('기다려!')">
    <div class="plant" name="green1"  type="button "onclick="alert('풀떼기!')"></div>
    </div>
    <div class="plantpot" name="plant2"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green2"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant3"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green3"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant4"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green4"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant5"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green5"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant6"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green6"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant7"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green7"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant8"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green8"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant9"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green9"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant10"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green10"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant11"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green11"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant12"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green12"  type="button "onclick="alert('풀떼기!')"></div></div>
...
<div class="Darkpot">
     ...
     <div class="plantpot" name="plant13"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green13"  type="button "onclick="alert('풀떼기!')"></div></div>


    <div class="plantpot" name="plant14"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green14"  type="button "onclick="alert('풀떼기!')"></div></div>
    
    <div class="plantpot" name="plant15"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green15"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant16"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green16"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant17"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green17"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant18"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green18"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant19"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green19"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant20"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green20"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant21"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green21"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant22"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green22"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant23"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green23"  type="button "onclick="alert('풀떼기!')"></div></div>

    <div class="plantpot" name="plant24"  type="button "onclick="alert('기다려!')">
        <div class="plant" name="green24"  type="button "onclick="alert('풀떼기!')"></div></div>
